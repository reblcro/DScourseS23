...
# Use this website for help with tidymodels: https://www.r-bloggers.com/2020/03/machine-learning-with-tidymodels/
...
# most helpful site is: https://emilhvitfeldt.github.io/ISLR-tidymodels-labs/08-tree-based-methods.html
# also somewhat helpful, but not for decision trees specifically: https://bcullen.rbind.io/post/2020-06-02-tidymodels-decision-tree-learning-in-r/
...
# YOU FILL IN THE REST
# most helpful site is: https://www.tidymodels.org/learn/models/parsnip-nnet/
...
# YOU FILL IN THE REST
# most helpful site is: https://emilhvitfeldt.github.io/ISLR-tidymodels-labs/09-support-vector-machines.html

#workflow to find best value of cost
svm_wf <- workflow() %>%
  add_formula(high.earner ~ .) %>% 
